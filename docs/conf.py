# -*- coding: utf-8 -*-
#
# sgsession documentation build configuration file, created by
...
htmlhelp_basename = 'sgsessiondoc'
...
latex_documents = [
  ('index', 'sgsession.tex', u'sgsession Documentation',
   u'Western X', 'manual'),
]
...
man_pages = [
    ('index', 'sgsession', u'sgsession Documentation',
     [u'Western X'], 1)
]
...
texinfo_documents = [
  ('index', 'sgsession', u'sgsession Documentation',
   u'Western X', 'sgsession', 'One line description of project.',
   'Miscellaneous'),
]
